export const danielboggiano = {
    name: 'Daniel Boggiano Sáenz',
    profession: {
      es: 'Desarrollador Full Stack',
      en: 'Full Stack Developer',
    },
    picture: '/assets/daniel-boggiano.jpg',
    habilities: [
    ...
    linkedin: '/daniel-boggiano-saenz',
    humanLanguaguages: [
      {
    ...
    references: [
      {
        nombre: 'Angel Barrios',
        empresa: 'Globant Peru',
        email: 'angel.barrios@globant.com',
        telefono: '+51 910 907 994',
      },
      {
