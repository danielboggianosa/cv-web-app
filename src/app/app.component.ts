...
export class AppComponent implements OnInit {
  ...
  profileDescription = {
    ...
    en: `Experienced Front End Software Developer adept to bringing forth expertise in design, more than 5 years working with Angular, installation, testing and maintenance of software systems. Equipped with a diverse and promising skill-set. Proficient in various platforms, languages, and embedded systems. Experienced with the latest cutting Edge development tools and procedures. Able to effectively self-manage during independent projects, as well as collaborate as part of a productive team.​`,
  };
  birthday = { es: '6 de marzo de 1987', en: 'March 6, 1987' };
  age = {
    es: new Date().getFullYear() - 1987 + ' años',
    en: new Date().getFullYear() - 1987 + ' years old',
  };
  ...
  languages = [
    ...
    {
      nombre: { es: 'Portugués', en: 'Portugese' },
      nivel: 75,
      color: 'primary',
    },
  ...
  frameworks = [
    ...
    { nombre: 'Vue', nivel: 75, color: 'success' },
  ...
  estudios = [
    {
      ...
      ciudad: 'Lima',
      inicio: { month: 1, year: 2010 },
      fin: { month: 12, year: 2012 },
    },
    {
      titulo: 'Traducción de Idiomas',
      institucion: 'Headway College',
      ciudad: 'Lima',
      inicio: { month: 3, year: 2005 },
      fin: { month: 12, year: 2007 },
    },
    // { titulo: 'Secundaria', institucion: 'G.U.E. José Granda', ciudad: 'Lima', inicio: '1999', fin: '2003' },
  ];
  referencias = [
    {
      nombre: 'Micaela Carrión',
      empresa: 'Globant Peru',
      email: 'micaela.carrion@globant.com',
    },
    {
      nombre: 'Ana Canuto',
      empresa: 'Distillery',
      email: 'ana.canuto@distillery.com',
    },
    {
      nombre: 'Ricardo Vilchez',
      empresa: 'Rimac Seguros',
      telefono: '+51 995 981 202',
    },
    {
      nombre: 'Frank Yupanki',
      empresa: 'Indra Company',
      telefono: '+51 954 161 870',
    },
    {
      nombre: 'Kevin Martel',
      empresa: 'IT Data Consulting',
      telefono: '+51 959 218 801',
    },
    {
      nombre: 'Ivan Navarro',
      empresa: 'Panacea Consultores',
      telefono: '+51 996 499 845',
    },
    {
      nombre: 'Alfredo Matías',
      empresa: 'CBE Industrial',
      telefono: '+51 972 138 691',
    },
  ];
  certificaciones = [
    {
    ...
    },
    {
      ...
      fecha: { month: 6, year: 2021 },
      codigo: 'UC-3856a987-668a-4436-881e-333117d8896f',
